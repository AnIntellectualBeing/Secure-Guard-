...
void loop()
{
 int state = digitalRead(RaspFace);
if(state == HIGH){
  SendMessage();
}
...
void SendMessage()
{
  ...
  SIM900A.println("AT+CMGS=\"+919999999999\"\r"); // Receiver's Mobile Number
  delay(1000);
  Serial.println("Set SMS Content");
  SIM900A.println("Face Detected"); // Message content
  delay(100);
  Serial.println("Done");
